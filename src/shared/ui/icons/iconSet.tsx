  ...
  boxOpen: (
    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
      <g fill="none">
        <path
          fill="#deeeff"
          d="M23.998 48c13.255 0 24-10.746 24-24s-10.745-24-24-24s-24 10.745-24 24c0 13.254 10.745 24 24 24"
        />
        <path
          fill="#2e3ecd"
          fill-rule="evenodd"
          d="m13.525 32.726l10.473 3.491l10.473-3.49V18.762l-10.473 3.49l-10.473-3.49z"
          clip-rule="evenodd"
        />
        <path
          fill="#6bafff"
          fill-rule="evenodd"
          d="m27.253 26.743l-3.255-3.255l-3.255 3.255l-7.218-2.406v-5.574l10.473 3.49l10.473-3.49v5.574z"
          clip-rule="evenodd"
        />
        <path fill="#2e3ecd" d="m27.489 25.745l10.473-3.491l-3.491-3.491l-10.473 3.49z" />
        <path fill="#6bafff" d="m13.525 18.762l10.473 3.491l10.473-3.49l-10.473-3.492z" />
        <path
          fill="#2e3ecd"
          d="m13.525 18.762l-3.49-3.49l10.472-3.928l3.49 3.928zm20.945 0l3.492-3.49l-10.473-3.928l-3.491 3.928z"
        />
        <path fill="#6bafff" d="m13.525 18.762l10.473-3.49v6.981z" />
        <path fill="#2e3ecd" d="m20.507 25.745l-10.473-3.491l3.491-3.491l10.473 3.49z" />
      </g>
    </svg>
  ),
  boxOpen2: (
    <svg fill="#87898D" width="32px" height="32px" viewBox="0 0 32 32" version="1.1">
